    ...
    <div class="row">
        <div class=" col-sm-12">
            <div class="breadcrumb">
                ...
                <li><a href="admin/categories">Cotigories</a></li>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="panel-heading">
                            <div class="panel-title">
                                ...
                                <div class="dlk-radio btn-group btn-group-justified">
                                    ...
                                    <label class="btn btn-success status <c:if test='${category.status eq false}'> pas </c:if>" style="padding: 10px 15px">
                        ...
                        <div id="category${category.id}" class="panel-collapse collapse">
                            <div class="category">
                                ...
                                <div class="dlk-radio btn-group btn-group-justified">
                                    ...
                                    <label class="btn btn-success status <c:if test="${item.status eq false}"> pas </c:if>">
                                        <input type="checkbox" value="1">
                                        <i class="fa fa-check glyphicon glyphicon-ok"></i></label>
